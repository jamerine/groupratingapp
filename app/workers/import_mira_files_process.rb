class ImportMiraFilesProcess
  ...
  def perform(representative_number, representative_abbreviated_name, weekly = false, file_url = nil)
    if weekly
      ...
      file_url ||= "https://s3.amazonaws.com/piarm/#{representative_abbreviated_name}/MIRA2FILW"

      import_file(file_url, 'weekly_miras')
      ...
      file_url ||= "https://s3.amazonaws.com/piarm/#{representative_abbreviated_name}/MIRA2FILE"

      import_file(file_url, 'miras')
