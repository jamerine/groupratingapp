    ...
    if account
      ...
      if policy_calculation
        ...
        if manual_class_calculation
          @payroll_calculation = PayrollCalculation.new(representative_number: representative.representative_number, policy_number: policy_calculation.policy_number, manual_class_calculation_id: manual_class_calculation.id, payroll_origin: 'mass_insert', data_source: 'user', recently_updated: true)
