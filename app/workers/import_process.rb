class ImportProcess
  ...
  def perform(representative_number, import_id, representative_abbreviated_name, group_rating_id, import_only, all_process = nil)
    ...
    ManualClassCalculation.by_representative(representative_number).bwc.destroy_all
    PayrollCalculation.by_representative(representative_number).bwc.destroy_all
    ClaimCalculation.by_representative(representative_number).bwc.delete_all
