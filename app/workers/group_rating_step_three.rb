  class GroupRatingStepThree
    include Sidekiq::Worker

    sidekiq_options queue: :group_rating_step_three
  ...
  def perform(step, process_representative, experience_period_lower_date, experience_period_upper_date, current_payroll_period_lower_date, group_rating_id)
    ...
    @group_rating.save
      ...
      GroupRatingStepFour.perform_async("4", @group_rating.process_representative, @group_rating.experience_period_lower_date, @group_rating.experience_period_upper_date, @group_rating.current_payroll_period_lower_date, @group_rating.id)
