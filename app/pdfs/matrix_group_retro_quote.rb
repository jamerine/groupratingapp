class MatrixGroupRetroQuote < MatrixPdfReport
  ...
  def table_data
    ...
    @data += [["Adjusted Premium", price(@policy_calculation.policy_adjusted_standard_premium)]]
    @data += [["Standard Premium", price(@policy_calculation.policy_total_standard_premium)]]
