class ArmGroupRetroContract < PdfReport
  ...
  def contract
    ...
    bounding_box([30, current_cursor], :width => 520, :height => 30) do
      text "#{@account.representative.company_name.upcase} shall assist the Client in the management of their workers’ compensation claims and advise on methods of cost control and claim reduction when appropriate. Management of the claim cost and work related disabilities until case closure.", size: 9
    end
    current_cursor = cursor
    bounding_box([0, current_cursor], :width => 30, :height => 15) do
      text "3.", indent_paragraphs: 15, size: 9
    ...
    bounding_box([45, current_cursor], :width => 500, :height => 32) do
      ...
      text "B.	 An Attorney chosen by #{@account.representative.company_name.upcase} can attend.", size: 9
    ...
    bounding_box([30, current_cursor], :width => 520, :height => 53) do
      text "The Client shall promptly notify of any material changes in the operation of the Client , including, but not limited to, mergers, acquisitions or significant adjustments to the Client’s payroll (such as an adjustment that results in changing the program on Compensation Insurance (“NCCI”) classification under which the Client was accepted into the program). The Client will notify of any pending court cases particular to any workers’ compensation claim that has not been finally adjudicated or settled as of the 3/30/2016 survey date.", size: 9
    end
    current_cursor = cursor
    bounding_box([0, current_cursor], :width => 30, :height => 15) do
    ...
    bounding_box([30, current_cursor], :width => 520, :height => 125) do
      text "#{@account.representative.company_name.upcase} MAKES NO GURANTEES, WARRANTIES, OR ASSURANCES REGARDING ANY PROJECTED FUTURE GROUP RATES ON CLIENTS’ BEHALF. Client acknowledges and understands that due to the timing of the application process and rating plan, year of the group plans, rates may change due to factors beyond #{@account.representative.company_name.upcase} and/or Client’s control. #{@account.representative.company_name.upcase} agrees to provide good faith estimates and projections concerning group rates that should provide reasonable basis for the client’s decision making. Client acknowledges and agrees to the administrative and service fee is subject to change annually and that payment of administrative fee does not guarantee participation, in the program. In the event Client becomes ineligible for group participation, payment received shall be applied to client’s fee for all other administrative services as outlined in this agreement.  If Client desires to withdraw from this program and request a refund of monies paid, it is understood and accepted that the refunded amount will be prorated for services rendered less a $75.00 processing fee. Client may withdraw their enrollment up to the first Monday in December  for that application year by submitting a written request to #{@account.representative.company_name.upcase}, P.O. Box 880, Hilliard, Ohio 43026, including a self-addressed stamped envelope.", size: 9
    end
    current_cursor = cursor
    bounding_box([0, current_cursor], :width => 30, :height => 15) do
      text "2.", indent_paragraphs: 15, size: 9
    ...
    bounding_box([30, current_cursor], :width => 520, :height => 40) do
      ...
      text "No employer may leave program once accepted and approved in the program. Restriction applies to any voluntary withdrawal, leasing or contracting with a PEO. ", size: 9
    end
    current_cursor = cursor
    bounding_box([0, current_cursor], :width => 30, :height => 15) do
      text "6.", indent_paragraphs: 15, size: 9
    ...
    bounding_box([30, current_cursor], :width => 520, :height => 90) do
      ...
      text "The Client shall promptly notify of any material changes in the operation of the Client, including, but not limited to, mergers, acquisitions or significant adjustments to the Client’s payroll (such as an adjustment that results in changing the National Council on Compensation Insurance (“NCCI”) classification under which the Client was accepted into the Program). The Client will notify of any pending court cases particular to any workers’ compensation claim that has not been finally adjudicated or settled as of the 9/30/2016 survey date. In addition, the Client shall promptly provide such other information in such form as is reasonably requested and otherwise reasonably cooperate with #{@account.representative.abbreviated_name.upcase} and NEOSC in the operation, administration and furtherance of the purposes of the Program.", size: 9
    end
    current_cursor = cursor
    bounding_box([0, current_cursor], :width => 30, :height => 15) do
      text "7.", indent_paragraphs: 15, size: 9
    ...
    bounding_box([30, current_cursor], :width => 520, :height => 130) do
      ...
      text "#{@account.representative.abbreviated_name.upcase} taking into account actuarial and other pertinent data, shall review each application to participate in the Program and shall determine whether to accept the applicant into the Program for the applicable rating year. For each rating year that NEOSC and #{@account.representative.abbreviated_name.upcase} determine to continue the Program, the Program shall file or cause to be filed an application to the BWC for each group (“Bureau Application”) in order to obtain the necessary Bureau approval for such group. All applicants that have been approved by NEOSC for participation in a group for a Rating Year shall be included in that year’s BWC Application for such group.
  		The Program and the participating employers are subject to acceptance and approval by the BWC. NEOSC nor #{@account.representative.abbreviated_name.upcase}T and the Program shall not have any liability to a client in the event that the BWC declares that the Program, or any group proposed for inclusion in the Program or any Client does not meet the necessary eligibility requirements of the BWC, thereby preventing a Client from participating in the Program.", size: 9
    end
    current_cursor = cursor
    bounding_box([0, current_cursor], :width => 30, :height => 15) do
