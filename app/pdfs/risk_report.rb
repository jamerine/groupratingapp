class RiskReport < PdfReport
  ...
  def claim_data(claims_array)
    ...
    @data +=  claims_array.map { |e| [e.claim_number, e.claimant_name.titleize, e.claim_injury_date.in_time_zone("America/New_York").strftime("%m/%d/%y"), e.claim_manual_number, "#{round((((e.claim_mira_reducible_indemnity_paid+(e.claim_mira_non_reducible_indemnity_paid + e.claim_mira_non_reducible_indemnity_paid_2))*(1 - e.claim_subrogation_percent)-(e.claim_mira_non_reducible_indemnity_paid + e.claim_mira_non_reducible_indemnity_paid_2))*(1 - e.claim_handicap_percent)+(e.claim_mira_non_reducible_indemnity_paid + e.claim_mira_non_reducible_indemnity_paid_2))*e.claim_group_multiplier,0)}", "#{round((((e.claim_medical_paid + e.claim_mira_medical_reserve_amount)*(1 - e.claim_subrogation_percent) - e.claim_mira_medical_reserve_amount)*(1 - e.claim_handicap_percent)+ e.claim_mira_medical_reserve_amount)*e.claim_group_multiplier,0)}", "#{round((1 - e.claim_handicap_percent)*(e.claim_mira_medical_reserve_amount+(e.claim_mira_indemnity_reserve_amount))* e.claim_group_multiplier* (1 - e.claim_subrogation_percent) ,0)}", round(e.claim_modified_losses_group_reduced,0), round(e.claim_modified_losses_individual_reduced, 0), "#{round(((e.claim_mira_reducible_indemnity_paid + e.claim_medical_paid + e.claim_mira_medical_reserve_amount + e.claim_mira_indemnity_reserve_amount - e.claim_total_subrogation_collected)*(1 - e.claim_handicap_percent)+(e.claim_mira_non_reducible_indemnity_paid + e.claim_mira_non_reducible_indemnity_paid_2) + e.claim_mira_medical_reserve_amount),0)}", percent(e.claim_handicap_percent), "#{claim_code_calc(e)}" ] }
