class ManualClassCalculationsController < ApplicationController
  ...
  def show
    ...
    @payroll_calculations     = PayrollCalculation.where(manual_number: @manual_class_calculation.manual_number, representative_number: @manual_class_calculation.representative_number, policy_number: @manual_class_calculation.policy_number)
