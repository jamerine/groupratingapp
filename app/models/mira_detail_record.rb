...
#  injured_worked_represented                             :boolean
#  claim_status                                           :string
...
#  indemnity_living_maintenance_reserve_prediction        :boolean
