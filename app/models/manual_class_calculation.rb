class ManualClassCalculation < ActiveRecord::Base
  ...
  def recalculate_experience
    self.transaction do
      ...
      policy_four_year_sum = @policy_calculation.manual_class_calculations.sum(:manual_class_four_year_period_payroll)
      ...
      @policy_calculation.update_attributes(policy_total_expected_losses: policy_expected_losses, policy_total_four_year_payroll: policy_four_year_sum, policy_total_current_payroll: policy_estimated_current_payroll )
      ...
      @policy_calculation.update_attributes(policy_credibility_percent: @credibility_row.credibility_percent, policy_credibility_group: @credibility_row.credibility_group, policy_total_limited_losses: policy_limited_losses, policy_maximum_claim_value: @credibility_row.group_maximum_value)
  ...
  def recalculate_premium
    ...
    @policy_calculation.manual_class_calculations.each do |manual_class_calculation|
      ...
      if @policy_calculation.group_rating_tier.nil?
        ...
        manual_class_group_total_rate = (1 + @policy_calculation.group_rating_tier) * manual_class_calculation.manual_class_base_rate * (1 + BwcCodesConstantValue.find_by(name: 'administrative_rate', completed_date: nil).rate )
