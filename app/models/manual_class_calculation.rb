class ManualClassCalculation < ActiveRecord::Base
  ...
  def calculate_payroll(plus_one_year=nil)
    self.transaction do
      ...
      # @policy_creation = manual.policy_calculation.policy_coverage_status_histories.order(:coverage_effective_date).where(coverage_status: 'ACTIV').first
      # @policy_creation = manual_class.policy_calculation.policy_coverage_status_histories.find_by(coverage_status: 'ACTIV')

      @policy_creation_dip = self.policy_calculation.policy_coverage_status_histories.find_by(coverage_status: 'DIP  ')
      # @policy_creation_dip = manual_class.policy_calculation.policy_coverage_status_histories.find_by(coverage_status: 'DIP  ')
      ...
      if @policy_creation.nil?
        ...
        # @policy_creation_date = manual_class.policy_calculation.policy_coverage_status_histories.order(:coverage_effective_date).first.coverage_effective_date
      else
      ...
      # @manual_class_self_four_year_sum = self.payroll_calculations.where("reporting_period_start_date BETWEEN :experience_period_lower_date and :experience_period_upper_date and (payroll_origin != :payroll_origin or payroll_origin != :payroll_origin_2 )", experience_period_lower_date: @self_four_year_payroll_lower_date, experience_period_upper_date: @group_rating.experience_period_upper_date, payroll_origin: 'full_transfer', payroll_origin_2: 'man_reclass_full_transfer').sum(:manual_class_payroll).round(2)
      ...
      # @manual_class_comb_four_year_sum = manual_class.payroll_calculations.where("(reporting_period_start_date BETWEEN :experience_period_lower_date and :experience_period_upper_date) and (payroll_origin IN ('partial_transfer', 'full_transfer', 'man_reclass_full_transfer', 'man_reclass_partial_transfer'))", experience_period_lower_date: @group_rating.experience_period_lower_date, experience_period_upper_date: @group_rating.experience_period_upper_date).sum(:manual_class_payroll).round(2)

      # @manual_class_comb_four_year_sum = manual_class.payroll_calculations.where("(reporting_period_start_date BETWEEN :experience_period_lower_date and :experience_period_upper_date) and (payroll_origin = :payroll_origin or payroll_origin = :payroll_origin_2)", experience_period_lower_date: @group_rating.experience_period_lower_date, experience_period_upper_date: @group_rating.experience_period_upper_date, payroll_origin: 'full_transfer', payroll_origin_2: 'man_reclass_full_transfer').sum(:manual_class_payroll).round(2)
      ...
      # @manual_class_comb_four_year_sum = manual_class.policy_calculation.manual_class_calculations.first.payroll_calculations.where("(reporting_period_start_date BETWEEN :experience_period_lower_date and :experience_period_upper_date) and payroll_origin IN ('partial_transfer', 'full_transfer', 'man_reclass_full_transfer', 'man_reclass_partial_transfer')", experience_period_lower_date: @group_rating.experience_period_lower_date, experience_period_upper_date: @group_rating.experience_period_upper_date).sum(:manual_class_payroll).round(2)
      ##########
      ...
      # @manual_class_current_payroll = manual_class.payroll_calculations.where("reporting_period_start_date >= :current_payroll_period_lower_date and reporting_period_start_date < :current_payroll_period_upper_date", current_payroll_period_lower_date: @group_rating.current_payroll_period_lower_date, current_payroll_period_upper_date: @group_rating.current_payroll_period_upper_date).sum(:manual_class_payroll).round(2)
