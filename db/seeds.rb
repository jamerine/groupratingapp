...
RepresentativesUser.create({user_id: 5, representative_id: 9})
...
RepresentativesUser.create({user_id: 5, representative_id: 17})
RepresentativesUser.create({user_id: 6, representative_id: 2})
RepresentativesUser.create({user_id: 6, representative_id: 10})
