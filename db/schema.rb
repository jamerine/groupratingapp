...
ActiveRecord::Schema.define(version: 20200717175935) do
  ...
  create_table "imports", force: :cascade do |t|
    ...
    t.integer  "weekly_miras_count"
    t.integer  "weekly_mira_details_records_count"
  end
  ...
  create_table "mira_detail_records_backup", id: false, force: :cascade do |t|
    t.integer  "id"
    t.integer  "representative_number"
    t.integer  "record_type"
    t.integer  "requestor_number"
    ...
    t.string   "catastrophic_claim"
    t.float    "icd1_code"
    t.string   "icd1_code_type"
    t.float    "icd2_code"
    t.string   "icd2_code_type"
    t.float    "icd3_code"
    t.string   "icd3_code_type"
    t.float    "average_weekly_wage"
    t.float    "claim_handicap_percent"
    t.date     "claim_handicap_percent_effective_date"
    t.string   "chiropractor"
  ...
  create_table "weekly_mira_detail_records", force: :cascade do |t|
    t.integer  "representative_number"
    t.integer  "record_type"
    t.integer  "requestor_number"
    t.integer  "policy_number"
  ...
  create_table "weekly_miras", force: :cascade do |t|
    t.string "single_rec"
  end
