class Step400Proc < ActiveRecord::Migration
  def up
    connection.execute(%q{
      CREATE OR REPLACE FUNCTION public.proc_step_400(process_representative integer,
  ...
  def down
    connection.execute(%q{
      DROP FUNCTION public.proc_step_400(integer, date, date, date, date);
    })
  end
end
