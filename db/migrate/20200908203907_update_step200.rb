class UpdateStep200 < ActiveRecord::Migration
  def up
    connection.execute(%q{
      ...
      (SELECT
        ...
        WHERE a.reporting_period_start_date is not null and a.representative_number = process_representative and a.reporting_period_start_date >= experience_period_lower_date and a.reporting_period_end_date >= b.policy_creation_date
        ORDER BY
          policy_number ASC,
          manual_class ASC,
