class Step302Proc4 < ActiveRecord::Migration
      def up
      ...
      $BODY$
        ...
        (SELECT
          ...
          c.manual_class_from as "re_classed_from_manual_number",
          c.manual_class_to as "re_classed_to_manual_number",
          a.reclass_manual_coverage_type,
          to_date((c.policy_year || '-01-01'), 'YYYY-MM-DD') as "reclass_creation_date",
          a.payroll_reporting_period_from_date as payroll_reporting_period_from_date,
          a.payroll_reporting_period_to_date as payroll_reporting_period_to_date,
          a.re_classed_to_manual_payroll_total as "re_classed_to_manual_payroll_total",
          'man_reclass' || '_' || a.payroll_origin as payroll_origin,
          'bwc' as data_source,
          run_date as created_at,
          run_date as updated_at
        FROM public.process_manual_reclass_tables a
        INNER JOIN public.bwc_annual_manual_class_changes c
        ON c.manual_class_from = a.re_classed_to_manual_number
            and a.representative_number = process_representative
        );
