class UpdateStep301 < ActiveRecord::Migration
  def up
    connection.execute(%q{
          -- Function: public.proc_step_301(integer, date, date, date, date)

      -- DROP FUNCTION public.proc_step_301(integer, date, date, date, date);

          CREATE OR REPLACE FUNCTION public.proc_step_301(
          ...
          $BODY$
            ...
            where a.representative_number = process_representative and b.policy_creation_date <= a.reporting_period_end_date
            );
