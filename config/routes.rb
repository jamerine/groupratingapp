...
#    claim_calculation_claim_note_claim_note_categories GET        /claim_calculations/:claim_calculation_id/claim_notes/:claim_note_id/claim_note_categories(.:format)          claim_note_categories#index
#                                                       POST       /claim_calculations/:claim_calculation_id/claim_notes/:claim_note_id/claim_note_categories(.:format)          claim_note_categories#create
#  new_claim_calculation_claim_note_claim_note_category GET        /claim_calculations/:claim_calculation_id/claim_notes/:claim_note_id/claim_note_categories/new(.:format)      claim_note_categories#new
# edit_claim_calculation_claim_note_claim_note_category GET        /claim_calculations/:claim_calculation_id/claim_notes/:claim_note_id/claim_note_categories/:id/edit(.:format) claim_note_categories#edit
#      claim_calculation_claim_note_claim_note_category GET        /claim_calculations/:claim_calculation_id/claim_notes/:claim_note_id/claim_note_categories/:id(.:format)      claim_note_categories#show
#                                                       PATCH      /claim_calculations/:claim_calculation_id/claim_notes/:claim_note_id/claim_note_categories/:id(.:format)      claim_note_categories#update
#                                                       PUT        /claim_calculations/:claim_calculation_id/claim_notes/:claim_note_id/claim_note_categories/:id(.:format)      claim_note_categories#update
#                                                       DELETE     /claim_calculations/:claim_calculation_id/claim_notes/:claim_note_id/claim_note_categories/:id(.:format)      claim_note_categories#destroy
